...
*/
	...
	public function post_to_user($user_id, $message, $friends_only = FALSE, $photo_id = '')
	{
		...
		if(!$this->post_to_wall_query($hash, $user_id, $message, FALSE, $friends_only, 'feed', $photo_id))
		{
...
*/
	...
	private function post_to_wall_query($hash, $to_id, $message, $official=FALSE, $friends_only=FALSE, $type='all', $photo_id)
	{
		$official = $official ? '1' : '';
